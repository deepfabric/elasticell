...
func (*QueryReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_querypb_87ca7fe82ffbbd73, []int{0}
}
...
func (*UintPred) Descriptor() ([]byte, []int) {
	return fileDescriptor_querypb_87ca7fe82ffbbd73, []int{1}
}
func (m *UintPred) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UintPred) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UintPred.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *UintPred) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UintPred.Merge(dst, src)
}
func (m *UintPred) XXX_Size() int {
	return m.Size()
}
func (m *UintPred) XXX_DiscardUnknown() {
	xxx_messageInfo_UintPred.DiscardUnknown(m)
}

var xxx_messageInfo_UintPred proto.InternalMessageInfo
...
func (*StrPred) Descriptor() ([]byte, []int) {
	return fileDescriptor_querypb_87ca7fe82ffbbd73, []int{2}
}
func (m *StrPred) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StrPred) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StrPred.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *StrPred) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StrPred.Merge(dst, src)
}
func (m *StrPred) XXX_Size() int {
	return m.Size()
}
func (m *StrPred) XXX_DiscardUnknown() {
	xxx_messageInfo_StrPred.DiscardUnknown(m)
}

var xxx_messageInfo_StrPred proto.InternalMessageInfo
...
func (*QueryRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_querypb_87ca7fe82ffbbd73, []int{3}
}
...
func (dst *QueryRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryRsp.Merge(dst, src)
}
...
func (*Document) Descriptor() ([]byte, []int) {
	return fileDescriptor_querypb_87ca7fe82ffbbd73, []int{4}
}
	...
	for iNdEx < l {
		...
		case 5:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Cells) == 0 {
					m.Cells = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 1:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.Order) == 0 {
					m.Order = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
...
func init() { proto.RegisterFile("querypb.proto", fileDescriptor_querypb_87ca7fe82ffbbd73) }

var fileDescriptor_querypb_87ca7fe82ffbbd73 = []byte{
