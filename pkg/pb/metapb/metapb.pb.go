...
type StoreMetric struct {
	Capacity         uint64 `protobuf:"varint,1,opt,name=capacity" json:"capacity"`
	Available        uint64 `protobuf:"varint,2,opt,name=available" json:"available"`
	CellCount        uint64 `protobuf:"varint,3,opt,name=cellCount" json:"cellCount"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *StoreMetric) Reset()                    { *m = StoreMetric{} }
func (m *StoreMetric) String() string            { return proto.CompactTextString(m) }
func (*StoreMetric) ProtoMessage()               {}
func (*StoreMetric) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{5} }

func (m *StoreMetric) GetCapacity() uint64 {
	if m != nil {
		return m.Capacity
	}
	return 0
...
func (m *StoreMetric) GetAvailable() uint64 {
	if m != nil {
		return m.Available
	}
	return 0
...
func (m *StoreMetric) GetCellCount() uint64 {
	if m != nil {
		return m.CellCount
	}
	return 0
...
type Store struct {
	...
	Metric           *StoreMetric `protobuf:"bytes,5,opt,name=Metric" json:"Metric,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (*Store) Descriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{6} }
...
func (m *Store) GetMetric() *StoreMetric {
	if m != nil {
		return m.Metric
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*StoreMetric)(nil), "metapb.StoreMetric")
...
func (m *StoreMetric) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StoreMetric) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x18
	i++
	i = encodeVarintMetapb(dAtA, i, uint64(m.CellCount))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *Store) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Metric != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(m.Metric.Size()))
...
func (m *StoreMetric) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreMetric: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreMetric: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CellCount |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetapb = []byte{
	...
	,
}
